...
namespace Artemisa.GStreamer 
{
   ...
   public class GstreamerInterop
   {
       ...
       static GstreamerInterop instance=null;
       ...
       public static GstreamerInterop Instance
       {
           get
           {
               lock (padlock)
       ...
       [DllImport(gObjDynamicLib)]
       static extern bool g_object_get(IntPtr ptr, string prop, ref string value, IntPtr NullTerminated);
