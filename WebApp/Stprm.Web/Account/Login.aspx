<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="Stprm.Web.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="body">
    ...
    <p>
        ...
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="false" Visible="false">Registrarse</asp:HyperLink>
    </p>
